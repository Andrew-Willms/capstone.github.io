...
| 10/12    | Reading Week/Created PDP slideshow | - | - | - | - | - |
| 10/19    | Midterm Week | - | - | - | - | - |
| 10/26    | Intermediate concepts and analysis/calculations for detailed design  | Developed formulas for control system design. Charted calculations in excel for optimization of gearbox/CAPSTAN gear ratios. Aided in motor torque and power calculations. | Aided in motor torque analysis. Worked on CAD development of goalie and arm mechanism. | Worked on creation of electrical schematic and related analysis/calculations.| Aided on more in depth conceptualization of goalie mechanism on end of arm, relating to motion of arms and lower body.  | Worked on conceptualizing/developing more detailed gearbox mechanism drawings. Aided in calculations relating to motor torque and gearbox/CAPSTAN calculations. |
